  ...
  return (
    <div className="p-4 sm:ml-80 bg-sky-400">
      <div className="relative pt-4 pb-[100px] border-2 border-gray-200  rounded-lg dark:border-gray-700 bg-white">
        ...
        <div className="py-8 px-[42px] flex flex-col ">
          <div className="relative" style={bgMain}>
            ...
            <div className="py-[42px] px-[56px]">
              <h2 className="font-semibold text-xl tracking-[-1px]">
                Chi tiết voucher
              </h2>
              <picture className="mt-[28px] flex justify-center items-center rounded-lg overflow-hidden">
                <img
                  src="./anhvoucher.png"
                  alt=""
                  className="w-[464px] object-cover "
                />
              </picture>
              <div className="mt-[28px] py-[28px] px-[25px] bg-white shadow-[0px_0px_4px_0px_rgba(0,0,0,0.25)]">
                <div className="flex flex-col gap-6">
                  <div className="flex items-center">
                    <span className="w-24">Giảm:</span>
                    <input
                      type="text"
                      defaultValue="10%"
                      className="outline-none p-3 rounded-lg border border-[#CACACA] bg-[#F7F7F7] w-[379px]"
                      readOnly
                    />
                  </div>
                  <div className="flex items-center">
                    <span className="w-24">Tối đa:</span>
                    <input
                      type="text"
                      defaultValue="10k"
                      className="outline-none p-3 rounded-lg border border-[#CACACA] bg-[#F7F7F7] w-[379px]"
              ...
              <div className=" py-[28px] px-[25px] bg-white shadow-[0px_0px_4px_0px_rgba(0,0,0,0.25)]">
                <div className="flex flex-col gap-6">
                  <div className="flex items-center">
                    <span className="w-52">Giá trị hóa đơn tối thiểu:</span>
                    <input
                      type="text"
                      defaultValue="50k"
                      className="outline-none p-3 rounded-lg border border-[#CACACA] bg-[#F7F7F7] w-[379px]"
                  ...
                  <div className="flex items-center">
                    <span className="w-52">Áp dụng cho các sản phẩm:</span>
                    <input
                      type="text"
                  ...
                  <div className="flex items-center">
                    <span className="w-52">Áp dụng cho khung giờ:</span>
                    <input
                      type="text"
          ...
          <div className="cta inline-flex justify-center items-center mt-[72px]">
            <button className="flex py-3 px-5 justify-center items-center bg-[#9654F4] border border-[#9654F4] w-[548px] text-white rounded-full shadow: 0px_1px_2px_0px_rgba(198,228,246,0.05)">
              Xác nhận
            </button>
          </div>
        </div>
