          ...
          <div className="bg-white px-6 rounded-lg w-[640px]">
            ...
            <div className="">
              <p className="font-normal text-base text-[#1E293B] pb-[24px]">
                Chiến dịch này đang diễn ra và đã có 1 số khách hàng lấy voucher
                của bạn. Việc xóa đi chiến dịch này sẽ làm ảnh hưởng đến trải
                nghiệm khách hàng của bạn. Bạn vẫn muốn xóa chứ
              </p>
              <div>
